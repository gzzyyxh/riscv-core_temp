...
`define EXE_CSR_INST 7'b1110011
...
`define CSR_REG_FFLAGS 1'h001
`define CSR_REG_FRM 3'h002
`define CSR_REG_FCSR 3'h003
`define CSR_REG_MSTATUS 3'h300
`define CSR_REG_MISA 3'h301
`define CSR_REG_MIE 12'h304
`define CSR_REG_MTVEC 3'h305
`define CSR_REG_MSCRATCH 3'h340
`define CSR_REG_MEPC 3'h 341
`define CSR_REG_MCAUSE 3'h342
`define CSR_REG_MTVAL 3'h343
`define CSR_REG_MIP 3'h344
`define CSR_REG_MCYCLE 3'hB00
`define CSR_REG_MCYCLEH 3'hB80
`define CSR_REG_MINSTRET 3'hB02
`define CSR_REG_MINSTRETH 3'hB82
`define CSR_REG_MVENDORID 3'hF11
`define CSR_REG_MARCHID 3'hF12
`define CSR_REG_MIMPID 3'hF13
`define CSR_REG_MHARTID 3'hF14
`define CSR_REG_MTINME 3'h000
`define CSR_REG_MTIMECMP 3'h000
`define CSR_REG_MSIP 3'h000
